...
add_action('acf/init', function () {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                'key' => 'field_honorary_patrons',
                'label' => 'Patroni Honorowi',
                'name' => 'honorary_patrons',
                'type' => 'repeater',
                'instructions' => 'Dodaj logotypy patronów honorowych.',
                'layout' => 'table',
                'button_label' => 'Dodaj Patrona',
                'sub_fields' => [
                    [
                        'key' => 'field_honorary_patron_logo',
                        'label' => 'Logo Patrona',
                        'name' => 'honorary_patron_logo',
                        'type' => 'image',
                        'return_format' => 'url',
                        'preview_size' => 'thumbnail',
                    ],
