...
<section data-gsap-anim="section" id="form" class="b-reach relative section-py -smt {{ $sectionClass }}" style="background-image: linear-gradient(to right, rgb(0, 6, 64, 0.5) 0%, rgb(0, 6, 64, 1.0) 40%, rgb(0, 6, 64, 1.0) 100%), url('{{ $g_reach_1['image']['url'] }}'); background-size: cover; background-position: center;">
